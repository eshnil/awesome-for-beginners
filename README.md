...
- [LearnAwesome](https://github.com/learn-awesome/learn/labels/first-timers-only) _(label: first-timers-only)_ <br> LearnAwesome is building humanity's universal learning map. Their webapp is written in Ruby on Rails.
